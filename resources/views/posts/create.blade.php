                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('posts.store') }}" method="POST" class="mt-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" class="border border-gray-300 dark:bg-gray-900 rounded-md px-4 py-2 w-full">
                        </div>
                        <div class="mb-4">
                            <label for="body" class="block text-gray-700 dark:text-gray-200 text-sm font-bold mb-2">Body</label>
                            <textarea name="body" id="body" class="border border-gray-300 dark:bg-gray-900 rounded-md px-4 py-2 w-full" rows="4"></textarea>
                        </div>
                        <div class="mb-4">
